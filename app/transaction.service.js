...
var TransactionService = (function () {
    function TransactionService(http) {
        ...
        this.transactionsUrl = 'api/transactions'; // URL to web api
    }
    ...
    TransactionService.prototype.getTransaction = function (id) {
        var url = this.transactionsUrl + "/" + id;
    ...
    TransactionService.prototype.create = function (name) {
        return this.http
    ...
    TransactionService.prototype.update = function (transaction) {
        var url = this.transactionsUrl + "/" + transaction.id;
        return this.http
