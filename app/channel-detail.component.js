...
var ChannelDetailComponent = (function () {
    function ChannelDetailComponent(route, location, channelService, router) {
        this.route = route;
    ...
    ChannelDetailComponent.prototype.goUpdate = function (channelid) {
    ...
    ChannelDetailComponent = __decorate([
        ...
        __metadata('design:paramtypes', [router_1.ActivatedRoute, common_1.Location, channel_service_1.ChannelService, router_1.Router])
